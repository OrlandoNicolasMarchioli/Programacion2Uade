 ...
 */
public interface IBinaryTreeExam {
     ...
     */
    void create(int value, int timesToAdd);
     ...
     */
    void addLeft(int value, int timesToAdd);
     ...
     */
    void addRight(int value, int timesToAdd);
